...
%        Graphic from~\cite{imageMichelsonInterferometerWiki}}
    ...
    But in addition to the main maxima, we observe the occurence of weaker secondary maxima.
    ...
    \begin{thebibliography}{}    %so wird das Literaturverzeichnis erstellt
        ...
        \bibitme{neonSpectrum} \url{https://www.physics.nist.gov/PhysRefData/Handbook/Tables/neontable3_a.htm} , last visited 12.03.2024
    \end{thebibliography}
