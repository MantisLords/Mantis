...
\begin{document}
    ...
    \begin{abstract}                                                %Beginn des Abstracts
        ...
        We studied vacuum diodes, electron evaporation and the Franck-Hertz effect with a simple experimental setup.
        With a variable heating and accelerating voltage we recorded the characteristic curve of a vacuum diode
        and observed the Langmuir-Schottky power law. 
        For heating voltages $\sixfiveV$ and $\sevenV$ we measured the exponents $\schottkySixFivePower$ and $\schottkySevenPower$ 
        respectivly.
        The deviation from the theoretical value $\frac{3}{2}$ of our setup was discussed.
        By varying the heating voltage we could see the Richarson law in the saturation region.
        It describes the carrier density as function of the heating temperature.
        We could estimate the work function $W_a = \richardsonModelWa$ of the cathode material.
        ...
        We used tetrodes filled with neon and mercury gas.
        From the graph we could estimate the excitation energy from the neon ground state to the $\neLevelA$-level
        as $\TransitionNeMeana$ and for mercury we got for the transition to the $\HgLevelA$-level $\TransitionHgMeana$.
        These energies were compared with the observed emitted light and with the theoretical transition energies.
...
%    It is marked by the vertical lines.
    ...
    \figschottky{
        ...
        We estimate the region by looking where the graph has a positive curvature.
        ...
        The plot's x-axis is shifted by the fitted contact voltage $U_k$, so the power law appears as a
