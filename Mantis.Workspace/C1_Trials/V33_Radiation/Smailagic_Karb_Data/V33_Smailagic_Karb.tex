...
\begin{document}
    ...
    \begin{abstract}%Beginn des Abstracts
        ...
        We examine the validity of the \textit{Stefan Boltzmann law} i.e. a $T^4$ dependence of the radiation with a setup which simulates a black body using a hollow chamber with dark walls.
        The determined exponent $T^b$ is $b=(\BlackBodyFitParameter)$ which coincides with the theoretically expected value of $4$.
    ...
    \begin{table}[htbp]          %so funktionieren die Tabellen in LaTeX
        ...
        This means, that the 4 surfaces of the leslie cube behave like a black-body radiatior for this specific spectral range.}  %siehe Graphik: Beschriftung
