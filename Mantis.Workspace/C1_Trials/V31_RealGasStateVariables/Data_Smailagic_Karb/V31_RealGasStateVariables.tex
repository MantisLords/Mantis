...
\begin{document}
    ...
    \begin{figure}
        \begin{center}
            \includegraphics[scale=0.18]{Data/Generated/fig_plot}
    ...
    \begin{figure}
        \begin{center}
            \includegraphics[scale=0.18]{Data/Generated/plotZoom}
    ...
    The exact steps that were taken to fit the Maxwell lines are detailed in the appendix \ref{sec:apendix}. % Make clear it referece to Maxwell Lines
    ...
    \begin{figure}
        \begin{center}
            \includegraphics[scale=0.18]{Data/Generated/fig_tempLogPlot}
