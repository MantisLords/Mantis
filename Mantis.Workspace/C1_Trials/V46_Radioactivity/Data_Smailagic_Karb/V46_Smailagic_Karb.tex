...
\begin{document}
    ...
    \begin{abstract}                                                %Beginn des Abstracts
        ...
        We use the $\gamma$-emitter \Cs and measure the equivalent dosis next to the sample $H$ and
        $d$ away $H$.
        The activity is under the year threshold $\yeardosis$, so the sample is safe to use for further experiments.
        ...
        Then we use the Geiger Müller counter to optain the half-life of the instable \Bam isotope $\Thalf$.
