...
using Mantis.Workspace.C1_Trials.V35_Ultrasound;
...
using Mantis.Workspace.C1_Trials.V46_Radioactivity;
...
FileManager.GlobalWorkspace = "C1_Trials/V46_Radioactivity/Data_Smailagic_Karb";
V46_Main.Process();
