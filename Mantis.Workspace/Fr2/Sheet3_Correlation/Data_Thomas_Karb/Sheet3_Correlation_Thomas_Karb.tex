...
\begin{document}
    ...
    \input{Generated/EnvironmentData}
    ...
    For this set we get:
    \input{Generated/TemperatureHumidityCovariance}
    ...
    \input{Generated/TemperatureHumidityCorrelation}
    ...
    \input{Generated/RegressionOffset}
    \input{Generated/RegressionSlope}

    \section{}
    If we plot the data from Table~\ref{EnvironmentData} and the linear fit we get the following
    \input{Generated/EnvironmentRegression}
